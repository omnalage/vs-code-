...
img_path = 'chessboard.png'  # Replace with your path
img = cv2.imread(img_path)
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

# ---------- 1. Harris Corner Detection ----------
def harris_corners(gray_img, k=0.04, threshold=0.01):
...
# Apply both
harris_result = harris_corners(gray)
sift_result = sift_features(gray)
